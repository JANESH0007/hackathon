...
const getAqiInfo = (aqi) => {
    ...
    if (aqi <= 150) return { status: 'Unhealthy for Sensitive', className: 'text-orange-800 bg-orange-100' };
        ...
        <div className="bg-white p-6 rounded-xl shadow-md h-full">
            ...
            <ul className="space-y-4">
                <li className="flex justify-between items-center">
                    <span className="font-semibold text-gray-600 flex items-center gap-2"><FaThermometerHalf className="text-red-500" /> Temperature</span>
                ...
                <li className="flex justify-between items-center">
                    <span className="font-semibold text-gray-600 flex items-center gap-2"><FaSmog className="text-gray-500" /> Gas Levels</span>
                    <span className="font-semibold text-green-600">{data.gasLevels}</span>
                </li>
                <li className="flex justify-between items-center">
                    <span className="font-semibold text-gray-600 flex items-center gap-2"><FaMapMarkerAlt className="text-gray-500" /> Location</span>
