...
const EnvironmentalMonitoring = () => (
    <div className="bg-white p-6 rounded-xl shadow-md h-full">
        ...
        <div className="space-y-3">
            <div className="flex justify-between items-center"><span className="text-gray-600 font-semibold">Gas Level Monitoring</span><span className="text-green-600 font-semibold px-2 py-0.5 bg-green-100 rounded-full text-sm">Normal</span></div>
            <div className="flex justify-between items-center"><span className="text-gray-600 font-semibold">Ventilation System</span><span className="text-green-600 font-semibold px-2 py-0.5 bg-green-100 rounded-full text-sm">Optimal</span></div>
            <div className="flex justify-between items-center"><span className="text-gray-600 font-semibold">Emergency Systems</span><span className="text-green-600 font-semibold px-2 py-0.5 bg-green-100 rounded-full text-sm">Active</span></div>
        </div>
    </div>
);
