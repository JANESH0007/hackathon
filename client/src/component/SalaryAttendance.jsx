    ...
    return (
        <div className="card salary-card">
            ...
            <div className="salary-breakdown">
                <p><span>Base Salary:</span> <span>{formatCurrency(data.base)}</span></p>
                <p><span>Safety Bonus:</span> <span className="text-green">+ {formatCurrency(data.safetyBonus)}</span></p>
                <p><span>Overtime:</span> <span className="text-green">+ {formatCurrency(data.overtime)}</span></p>
            </div>
            <button className="btn btn-secondary"><FaRegCreditCard /> View Payslip</button>
        </div>
    );
};
