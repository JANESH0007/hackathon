...
import VideoCommunication from './VideoCommunication.jsx';
...
const Dashboard = () => {
    ...
    const instructions = [
        ...
        { id: 2, title: 'Coal extraction - Section B', status: 'progress', detail: 'In progress - 65% complete' },
        ...
        <div className="dashboard-container">
            ...
            <div className="main-content">
                ...
                <div className="dashboard-grid">
                    ...
                    <InfoCard icon={<FaExclamationTriangle />} title="Alerts" value="3" subtext="2 new, 1 pending" alert={true} />
